...
celllevel <- c(
  ...
  "Meninge" = "predicted.celltype.l1",
  "Skull" = "predicted.celltype.l1"
)
...
readr::write_rds(
  ...
  file = "data/azimuth/project_sc_azimuth_refumap_unique_celltype_union_anno_cell_newp-1.rds.gz"
)
  ...
  purrr::map(
    .f = function(.region) {
      ...
      ggsave(
        ...
        plot = .p,
        device = "pdf",
        path = "/mnt/isilon/xing_lab/liuc9/projnet/2022-02-08-single-cell/scuvresult/06-azimuth-celllevel",
        width = 10,
        height = 8
      )
...
writexl::write_xlsx(
  celltype_ratio,
  path = "/mnt/isilon/xing_lab/liuc9/projnet/2022-02-08-single-cell/scuvresult/06-azimuth-celllevel/celltype_ratio.xlsx"
)
